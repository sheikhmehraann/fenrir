...
DEVICES = [
    ...
    Device(
        ...
        'Infinix ZERO 40 5G',
        {
            ...
            'override_device_lock': PatchStage(
                'override_device_lock',
                pattern='21 00 80 52 4c 61 00 94 f6 03 1f 2a 60 00 80 52',
                replacement='21 00 80 52 4c 61 00 94 36 00 80 52 60 00 80 52',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Override device lock check flag in lk',
            ),
            'override_sec_cfg_state': PatchStage(
                'override_sec_cfg_state',
                pattern='c0 03 5f d6 48 03 00 90 00 3d 0a b9 c0 03 5f d6',
                replacement='c0 03 5f d6 48 03 00 90 1f 3d 0a b9 c0 03 5f d6',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Override sec_cfg state accessor in lk',
            ),
        },
        cert_bypass=CertBypass.OVERRIDE
    ),
